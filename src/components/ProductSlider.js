              ...
              {page.productList.map((products, index) => {
                ...
                return (
                  <div className='w-full max-w-[290px] h-[380px] text-left' key={index}>
                    <div className='border hover:bg-blue-900 rounded-[18px] w-full max-w-[285px] h-full max-h-[292px] flex items-center justify-center mb-[15px] relative transition'>
                    ...
                    <div className='flex items-center gap-x-3'>
                      <div>{price} ETH</div>
                      <div className='text-[13px] text-grey line-through'>{oldPrice} ETH</div>
                      <div>{Time}</div>
                    </div>
                  </div>
                );
